<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>An increase in gdp is assumed to increase housing_price_index.</td>
            <td>https://fred.stlouisfed.org/series/GDP</td>
        </tr>
        <tr>
            <td>total_expenditures</td>
            <td>Total US governmnt spending</td>
            <td>When this increases, housing_price_index increase.</td>
        ...
        <tr>
            ...
            <td>When this increases, housing_price_index decrease</td>
        ...
        <tr>
            ...
            <td>Number of people not in labor force but searched for work and is available for hire</td>
        ...
        <tr>
            ...
            <td>The interest rate banks and lend reserve balances to other banks overnight.</td>
            <td>when this increases, housing_price_index decrease</td>
